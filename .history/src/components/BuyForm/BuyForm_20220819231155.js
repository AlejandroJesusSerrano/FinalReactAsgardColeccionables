                                ...
                                <div className="card card-body bg-dark text-warning">
                                    <div className='form-group'>
                                        ...
                                        <div className="lastN mb-3">
                                            <input name="lastNames" id="lastNames"  type="text" value={formData.lastNames} onChange={addInputs} placeholder='Apellido/s:' />
                                        </div>
                                        <div className="email mb-3">
                                            <input type="mail" name='mail' id='mail' value={formData.mail} onChange={addInputs} placeholder='Direccion de E-m@il:'/>
                                        </div>
                                        <div className="phone mb-3">
                                            <input type="text" name='phone' id='cel' value={formData.phone} onChange={addInputs} placeholder='Nùmero de telefono:'/>
                                        </div>
