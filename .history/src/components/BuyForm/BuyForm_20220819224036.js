                            ...
                            <form className="buy-form" onSubmit={sendOrder}>
                                <div className="containerForm">
                                    <div className="name">
                                        ...
                                        <input name="names" id="names"  type="text" value={form.names} onChange={addInputs}/>
                                    </div>
                                    <div className="lastN">
                                        <label htmlfor="lastNames">Apellido/s:</label>
                                        <input name="lastNames" id="lastNames"  type="text" value={form.lastNames} onChange={addInputs}/>
                                    </div>
                                    <div className="email">
                                        <label htmlfor="mail">Email:</label>
                                        <input type="mail" name='mail' id='mail' value={form.mail} onChange={addInputs}/>
                                    </div>
                                    <div className="phone">
                                        <label htmlfor="cel">Teléfono:</label>
                                        <input type="text" name='cel' id='cel' value={form.phone} onChange={addInputs}/>
                                    </div>
