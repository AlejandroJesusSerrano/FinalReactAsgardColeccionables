        ...
        <div className='orderForm'>
            {loading 
                ...
                :   <div className='row container'>
                        ...
                        <div className='col-md-7 mx-auto pb-3 mb-3 formContStyles'>
                                            ...
                                            <div className='row g-0'>
                                                <div className='col-md-8'>
                                                    <div className="card-body">
                                                        <h3 className='card-text'>Producto: {products.title}</h3>
                                                        <h4 className='card-text'>Precio: ${products.price}</h4>
                                                        <h4 className='card-text'>Cantidad: {products.quant}</h4>
                                                    </div>
