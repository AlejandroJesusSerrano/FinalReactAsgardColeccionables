  ...
  return (
    <div>
        <div className="container-fluid pb-3 my-3 row impressionLight">
          ...
          <div className="container-fluid mx-auto px-auto col-md-6">
          ...
          <div className="container-fluid mx-auto pt-1 mt-1 col-md-8">
          <div className="card text-bg-warning mb-3" style={{maxWidth: 620}}>
